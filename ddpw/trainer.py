...
class Trainer(object):
  ...
  and evaluation methods to access training-specific aspects."""

  artefacts: ArtefactsConfig = None
  r"""Model-related configuration. This property may be used in the training and
  evaluation methods to access models, datasets, such as the optimisation
  stragegy (the optimiser) or the optimisation objective (energy/loss functions)
  `etc.`"""

  @abc.abstractmethod
  def train(self, global_rank: int):
    r"""(To be defined by the user) This method provides definition for the
    training procedure.
